          ...
          <Col sm={12} md={6} className={styles['about-me__col']}>
            <article className={styles['about-me__article']}>
              ...
              <Type>
                ...
                of commercial experience architecting and building web and
                mobile applications and well as backend services and api{"'"}s
                for clients across a wide range of industries including
                Automotive, Banking, E-Commerce, Public Sector and more. Some of
                the clients I have worked for include Google, Meta, Fox, UK Home
                Office, Nike, LEGO, HSBC, AstraZeneca, Ford, Shell, Klarna and
                many more.
              </Type>
              <Type>
                I lead the technical solution design as well as leading the
                hands-on development of frontend and backend code and DevOps
                ...
                Cloud to implement microservice based solutions.
              </Type>
            </article>
          </Col>
          <Col sm={12} md={6} className={styles['about-me__col']}>
